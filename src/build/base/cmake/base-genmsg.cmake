...
message(STATUS "base: 2 messages, 0 services")

set(MSG_I_FLAGS "-Ibase:/home/user/hupf_catkin_ws/src/base/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Wheels.msg" NAME_WE)
add_custom_target(_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "base" "/home/user/hupf_catkin_ws/src/base/msg/Wheels.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Angle.msg" NAME_WE)
add_custom_target(_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "base" "/home/user/hupf_catkin_ws/src/base/msg/Angle.msg" "std_msgs/Header"
)
...
### Generating Messages
_generate_msg_cpp(base
  "/home/user/hupf_catkin_ws/src/base/msg/Wheels.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/noetic/share/std_msgs/cmake/../msg/Header.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/base
)
_generate_msg_cpp(base
  "/home/user/hupf_catkin_ws/src/base/msg/Angle.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/noetic/share/std_msgs/cmake/../msg/Header.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/base
)
...
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Wheels.msg" NAME_WE)
add_dependencies(base_generate_messages_cpp _base_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Angle.msg" NAME_WE)
add_dependencies(base_generate_messages_cpp _base_generate_messages_check_deps_${_filename})
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Wheels.msg" NAME_WE)
add_dependencies(base_generate_messages_eus _base_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Angle.msg" NAME_WE)
add_dependencies(base_generate_messages_eus _base_generate_messages_check_deps_${_filename})
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Wheels.msg" NAME_WE)
add_dependencies(base_generate_messages_lisp _base_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Angle.msg" NAME_WE)
add_dependencies(base_generate_messages_lisp _base_generate_messages_check_deps_${_filename})
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Wheels.msg" NAME_WE)
add_dependencies(base_generate_messages_nodejs _base_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Angle.msg" NAME_WE)
add_dependencies(base_generate_messages_nodejs _base_generate_messages_check_deps_${_filename})
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Wheels.msg" NAME_WE)
add_dependencies(base_generate_messages_py _base_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/user/hupf_catkin_ws/src/base/msg/Angle.msg" NAME_WE)
add_dependencies(base_generate_messages_py _base_generate_messages_check_deps_${_filename})
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/base)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/base\")")
  # install generated code
  install(
